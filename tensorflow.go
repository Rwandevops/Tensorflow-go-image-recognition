...
const (
	graphFile  = "./tensorflow/tensorflow_inception_graph.pb"
	labelsFile = "./tensorflow/imagenet_comp_graph_label_strings.txt"
)
...
// TensorflowMain fonction qui gère la reconnaissance d'image
var TensorflowMain = func(imageLink string) []Label {
